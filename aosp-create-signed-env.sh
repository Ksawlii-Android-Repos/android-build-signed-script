...
read -p "Enter organization name 'AOSP' (O): " organization
read -p "Enter organizational unit 'AOSP' (OU): " organizational_unit
read -p "Enter common name 'AOSP' (CN): " common_name
